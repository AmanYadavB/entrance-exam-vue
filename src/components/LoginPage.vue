        ...
        <div class="border border-info rounded flex-basis-70 bg-white shadow">
            <b-container fluid class="m-4">
                ...
                <b-row class="my-3">
                    ...
                    <b-col sm="9">
                    <b-form-input id="input-none" :state="isPasswordValid" placeholder="Password" class="input-overflow" v-model="form.password" @input="onPasswordInput"></b-form-input>
                    </b-col>
                ...
                <div class="flex jc-space-between">
                    <b-button class="bg-warning border-white text-dark ps-3 pe-3 fs-5" href="" @click="loginUser">Login</b-button>
